...
front_thigh = Link(front_servo, front_knee, thigh_length_mm, angle=Angle.from_degrees(250), rate=None, id="front thigh")
rear_thigh = Link(rear_servo, rear_knee, thigh_length_mm, angle=Angle.from_degrees(10), rate=None, id="rear thigh")
